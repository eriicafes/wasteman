...
export function WelcomeBox() {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 mx-auto max-w-max rounded-[30px] p-2">
      {expanded ? (
        <div className="relative flex w-screen max-w-sm flex-col items-center gap-y-2 overflow-hidden rounded-[30px] bg-slate-800 p-2 md:gap-y-5">
          <button onClick={() => setExpanded(false)} className="absolute right-4 top-4 rounded-full bg-slate-100/40">
