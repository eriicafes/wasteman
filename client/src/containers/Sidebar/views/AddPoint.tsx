    ...
    <div className="h-full space-y-6 overflow-y-scroll pb-4">
      <div className="px-4">
        ...
        <form className="mt-6 space-y-5">
          <input type="email" placeholder="Name" className="w-full border bg-transparent py-3 px-3" />

          <div className="flex gap-x-4">
            <input type="text" placeholder="Longitude" className="w-full border bg-transparent py-3 px-3" />
            <input type="text" placeholder="Latitude" className="w-full border bg-transparent py-3 px-3" />
          </div>
